...
- grid.js – It manages the grid structure and also the placement of tiles.
- input.js – It Handles mouse clicks or trackpad tap and translates them into actions.
- renderer.js – It draws tiles and visual on the canvas.
- tile.js – It represent individual tiles and their Movement or Directional behavior.
- wave.js – It Counts beam paths and checks if the puzzle is solved ot not.
